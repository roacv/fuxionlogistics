...
import { GiCargoShip} from "@react-icons/all-files/gi/GiCargoShip";
...
<div className="row w-75 row-cols-1 row-cols-md-2 g-4 d-flex ms-auto me-auto">
  <div className="col">
    <div className="card  h-100 baseBlock">
      <p className="iconservicio text-center"><GiCommercialAirplane/></p>
  ...
  <div className="col">
    <div className="card h-100 baseBlock">
      <p className="iconservicio text-center"><FaTruck/></p>
      <div className="card-body">
  ...
  <div className="col">
    <div className="card h-100 baseBlock">
      <p className="iconservicio text-center"><FaMoneyBillWave/></p>
      <div className="card-body">
