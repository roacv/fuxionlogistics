  ...
  <div className="carousel-inner">
    <div className="carousel-item active" data-bs-interval="2500">
      ...
      <div className="carousel-caption d-none d-md-block">
        <h1 className="" style={{marginTop:"-72%"}}>Conectando el Mundo: Su Socio de Confianza en Flete Internacional</h1>
    ...
    <div className="carousel-item" data-bs-interval="2500">
      ...
      <div className="carousel-caption d-none d-md-block">
        <h1 className="text-start" style={{marginTop:"-65%",backgroundColor:"rgba(0,0,0,0.7)",marginRight:"81%"}}>Flete Marítimo</h1>
    ...
    <div className="carousel-item" data-bs-interval="2500">
      ...
      <div className="carousel-caption d-none d-md-block">
        <h1 className="text-start" style={{marginTop:"-65%",color:"black"}}>Flete Aéreo</h1>
    ...
    <div className="carousel-item" data-bs-interval="2500">
      ...
      <div className="carousel-caption d-none d-md-block">
        <h1 className="text-start" style={{marginTop:"-42%"}}>Flete Terrestre Internacional</h1>
